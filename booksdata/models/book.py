...
class Book(models.Model):
    ...
    book_count = models.IntegerField('借阅次数', default=0)
    ...
    book_person_dept = models.ForeignKey('Department',  blank=True, null=True, default='', on_delete=CASCADE)
    ...
    if_new = models.IntegerField('新书', default=0)
